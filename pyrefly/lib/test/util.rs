...
impl TestEnv {
    ...
    pub fn enable_import_cycle_error(mut self) -> Self {
        self.import_cycle_error = true;
        self
    }
    ...
    pub fn config(&self) -> ArcId<ConfigFile> {
        ...
        if self.import_cycle_error {
            errors.set_error_severity(ErrorKind::ImportCycle, Severity::Error);
        }
