...
| `any_exprs_report`                 | `pyrefly coverage expressions`                                                      | Manual; different counting rules   | Reports inferred expression types containing `Any` as JSON, with per-module counts and an aggregate percentage.                                                                                                                                                                               |
